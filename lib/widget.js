...
dump("WHAT IS THIS??? " + typeof initDisposable + ", " + typeof dispose + ", " + typeof setupDisposable + ", " + Object.keys(require("sdk/core/disposable")).join("; ") + "\n");
...
exports.create = function() {
  CustomizableUI.createWidget({
    ...
    onBuild: function(document) {
      ...
      buttons.forEach(function(button, idx) {
        ...
        if (button.oncommand) {
          btnNode.addEventListener("command", function(e) {
            button.oncommand(e);
          }, false);
        }
      });
  ...
  Class({
    ...
    dispose: () => CustomizableUI.destroyWidget(kWidgetID)
  });
};
