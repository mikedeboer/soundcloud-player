...
const kAssets = {
  ...
  "toolbarButtonsGlyphInverted": "soundcloud-player-inverted.png",
  "toolbarButtonsGlyphInverted2x": "soundcloud-player-inverted@2x.png"
};
...
exports.load = function(document, buttons) {
  ...
  console.log("SHEET::\n",parseSheet(sheet, buttons, defines));
