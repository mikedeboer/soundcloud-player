...
const setPlayButtonLabel = function(playButton, state) {
  ...
  playButton.setAttribute("label", state == STATE_PLAYING ? pauseLabel : playLabel);
  playButton.setAttribute("tooltiptext", state == STATE_PLAYING ? pauseTooltip : playTooltip);
}
  ...
  for (let node of playerNodes) {
    ...
    switch (state) {
      ...
      case STATE_PLAYING:
        ...
        break;
      case STATE_DISABLED:
        playButton.setAttribute("state", STATE_PLAYING);
